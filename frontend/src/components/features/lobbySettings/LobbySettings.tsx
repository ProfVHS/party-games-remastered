      ...
      <AnimatePresence>
        {minigamesModal && (
          <Modal onClose={() => setMinigamesModal(false)}>
            <MinigamesList onCancel={() => setMinigamesModal(false)} onSave={(minigames: MinigameEntryType[]) => setNewSettings({ ...newSettings, minigames })} minigames={newSettings.minigames || []} />
          </Modal>
        )}
      </AnimatePresence>
    </div>
