...
import { LobbySettingsType, TMinigameData } from '../../../types';
      ...
      <AnimatePresence>
        {minigamesModal && (
          <Modal onClose={() => setMinigamesModal(false)}>
            <MinigamesList onCancel={() => setMinigamesModal(false)} onSave={(minigames: TMinigameData[]) => setNewSettings({ ...newSettings, minigames })} minigames={newSettings.minigames || []} />
          </Modal>
        )}
      </AnimatePresence>
    </div>
