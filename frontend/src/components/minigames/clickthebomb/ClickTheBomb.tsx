...
export const ClickTheBomb = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Bomb />
        <span className="click-the-bomb__counter">
          {clicksCount! >= 10 ? clicksCount : '0' + clicksCount}
        </span>
        <span className="click-the-bomb__timer">
          {formatMilisecondsToTimer(timeLeft)}
        </span>
      </div>
      <Button
